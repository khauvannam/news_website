...
<script>
    ...
    const searchForm = document.getElementById("searchForm");
        ...
        searchForm.classList.toggle("z-50");
    }
    ...
    window.onclick = function (event) {
        ...
        if (
            ...
            searchForm.classList.remove("z-50");
        }
    };
</script>
    ...
    <div class="bg-white shadow">
      ...
      >
        ...
        <a href="#" class="flex items-center space-x-2">
          <img src="<?php ROOT_URL ?>public/image/logo.webp" alt="Vina Office Logo" class="h-20 z-50"  />
        </a>

        <!-- Navigation Links -->
        <nav
          class="hidden md:flex space-x-6 text-blue-800 text-sm font-semibold z-50"
        >
          ...
          <a href="#" class="hover:text-blue-600">THÀNH LẬ  P CÔNG TY</a>
